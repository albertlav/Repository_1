#CreateProcessAsUser by murrayju
...
#can for example display something to user if runned from task scheduler as system...
...
[murrayju.ProcessExtensions.ProcessExtensions]::StartProcessAsCurrentUser('notepad.exe')