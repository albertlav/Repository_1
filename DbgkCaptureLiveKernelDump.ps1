<#
Creates Kernel Dump of live running Windows system without blue screen stop, using bare powershell
Basically it tries to reproduce behavior of Sysinternals LiveKd.exe with -ml param
lot of unknown params.. but it works
Make sure you have SeDebugPrivilege
result will go to %temp%
#>
